    ...
    <div x-data="{ sidebarIsOpen: false }" class="relative flex w-full flex-col md:flex-row">
        ...
        <nav x-cloak
            ...
            <a href="#"
                ...
                <img src="{{ asset('images/logo.png') }}" alt="logo" class="h-10 w-10 inline" /> DRDI
            </a>
